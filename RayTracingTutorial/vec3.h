...
public:
	...
	__device__ vec3(double x, double y, double z) : arr{ x, y, z } {}

	__device__ double x() const { return arr[0]; }
	__device__ double y() const { return arr[1]; }
	__device__ double z() const { return arr[2]; }

	__device__ vec3 operator-() const { return vec3(-arr[0], -arr[1], -arr[2]); }
	...
	__device__ double length() const { return std::sqrt(length_squared()); }

	__device__ double length_squared() const { return arr[0] * arr[0] + arr[1] * arr[1] + arr[2] * arr[2]; }
